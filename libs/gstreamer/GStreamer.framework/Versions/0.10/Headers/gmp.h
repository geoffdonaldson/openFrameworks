...
#define __GMP_CFLAGS " -g -O2 -arch x86_64 -m64 -I/Library/Frameworks/GStreamer.framework/Versions/0.10/include -mmacosx-version-min=10.6 -isysroot /Developer/SDKs/MacOSX10.6.sdk "
