...
_pygst_dir = '/Library/Frameworks/GStreamer.framework/Versions/0.10/lib/python2.7/site-packages/gst-0.10'
...
def require(version):
    ...
    # try to provide a relative path if _pygst_dir doesn't exists for
    # relocations
    _rel_pygst_dir = os.path.join(os.path.dirname(__file__), 'gst-0.10')
    if not os.path.exists(_pygst_dir) and os.path.exists(_rel_pygst_dir):
        _pygst_dir = _rel_pygst_dir
